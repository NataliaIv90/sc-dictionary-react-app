...
export default function Phonetics(props) {
  function listenPhonetics(event) {
    event.preventDefault();
    var audio = new Audio(props.data);
    audio.play();
  }
        ...
        <a href="./" onClick={listenPhonetics}>
          <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512">
            <g>
              <g>
                <path
                  d="M240.419,42.298l-129.114,96.836H16.696C7.475,139.133,0,146.608,0,155.829v200.35c0,9.221,7.475,16.696,16.696,16.696
            ...
            <g>
              <g>
                <path
                  d="M438.761,78.919c-6.519-6.52-17.091-6.52-23.611,0c-6.52,6.52-6.52,17.091,0,23.611
            ...
            <g>
              <g>
                <path
                  d="M391.545,126.124c-6.52-6.523-17.092-6.524-23.611-0.006c-6.521,6.518-6.525,17.09-0.007,23.611
            ...
            <g>
              <g>
                <path
                  d="M344.342,173.373c-6.518-6.522-17.09-6.522-23.611-0.004c-6.521,6.519-6.524,17.09-0.004,23.611
